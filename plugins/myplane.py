...
async def start(client, message):
    ...
    if user == "Free":
        await message.reply(text, quote=True, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Upgrade 💰💳", callback_data="upgrade")],[InlineKeyboardButtonrdButton("Cancel ✖️ ", callback_data="cancel")]]))
    else:
